...
ActiveRecord::Schema.define(:version => 20170312201004) do
  ...
  create_table "antok_members2014", :id => false, :force => true do |t|
    t.integer  "id"
    t.string   "antok_id"
    t.string   "fio"
    t.date     "birth_date"
  ...
  create_table "applics2014", :id => false, :force => true do |t|
    t.integer  "id"
    t.integer  "user_id"
    t.string   "fio"
    t.string   "fio_eng"
  ...
  create_table "kofst_applics2014", :id => false, :force => true do |t|
    t.integer  "id"
    t.integer  "user_id"
    t.string   "applic_language"
    t.string   "korean_name"
